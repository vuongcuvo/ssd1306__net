...
namespace OledNameSpace
{
    class Oled
    {
        ...
        private static byte[,] s_chDispalyBuffer;
        ...
        public Oled()
        {
            s_chDispalyBuffer = new byte[128,8];
        }

        private void ssd1306_write_byte(byte chData, byte chCmd)
        {
            byte cmd = 0x00;
        ...
        private void ssd1306_display_on(void)
        {
