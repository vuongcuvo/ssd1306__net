...
namespace Demo
{
    static class I2C
    {
        ...
        static I2C()
        {
            ...
            {
                Console.WriteLine("Open FTDI device successfully");
            }
            ...
            {
                Console.WriteLine("I2C_ConfigureMpsse done");
            }
        }
        //###################################################################################################################################
        //###################################################################################################################################
...
# else
        ...
        public static byte I2C_SetLineStatesIdle()
        {
            byte ADbusVal = 0;
            byte ADbusDir = 0;
            NumBytesToSend = 0;
        ...
        public static byte I2C_GetGPIOValuesLow()
        {
            NumBytesToSend = 0;
        ...
        public static byte I2C_SetGPIOValuesHigh(byte ACbusDir, byte ACbusVal)
        {
            NumBytesToSend = 0;
        ...
        public static byte I2C_GetGPIOValuesHigh()
        {
            NumBytesToSend = 0;
